...
function XMPPSession(aHost, aPort, aSecurity, aJID, aDomain, aPassword, aListener) {
  ...
  this._resource = "Crow"; //TODO: pass this
...
XMPPSession.prototype = {
  ...
  send: function(aMsg) {
    if(this._state != STATE.disconnected) {
      ...
      this._listener.onSendTrace(aMsg);
    }
  },
  ...
  onXmppStanza: function(aName, aStanza) {
    this._listener.onReceiveTrace(aStanza.convertToString());
...
// exports
window.xmpp = {}
window.xmpp.session = session
window.xmpp.Stanza = Stanza
